...
# print(f'model-historical-simulation.py loaded from {TOP}/data.')
...
class Model_Historical_Simuluation():
    ...
    def __calc_profit(self, index, current_date, verbose=0):
        ...
        if index == 0:
            ...
            if self.shares>0 and high_diff>0:
                print('JKSE high of day greater than top of confidence interval by %.2f' % high_diff) if verbose>1 else None
                ...
                print('JKSE low of day less than bottom of confidence interval by %.2f' % low_diff) if verbose>1 else None
    ...
    def main(self):
        print('Running `JKSE` model historical simulation...\n') if self.verbose else None
